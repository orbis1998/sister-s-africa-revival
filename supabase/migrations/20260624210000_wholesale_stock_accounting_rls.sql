-- Wholesale: restore POS stock decrement + relax manager RLS for wholesale/expenses
...
-- RLS wholesale: can_record_wholesale OR can_view_accounting
...
-- RLS expenses: can_record_expenses OR can_view_accounting
