...
type Role = "admin" | "manager" | "livreur";
...
export const adminCreateUser = createServerFn({ method: "POST" })
  ...
  .inputValidator((d: {
    ...
    badge_id?: string; role: Role; permissions?: Record<string, boolean>; pos_ids?: string[];
  }) => d)
...
export const adminUpsertProduct = createServerFn({ method: "POST" })
  ...
  .inputValidator((d: {
    ...
    price_usd: number; price_fcfa: number; image_url?: string;
